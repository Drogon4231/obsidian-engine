...
PARAM_BOUNDS: dict[str, tuple[float, float]] = {
    ...
    "ducking.speech_volume":       (0.03, 0.25),
    "ducking.silence_volume":      (0.15, 0.40),
    "ducking.attack_seconds":      (0.05, 0.25),
    "ducking.release_seconds":     (0.20, 0.80),
    "ducking.ramp_seconds":        (0.35, 1.0),  # deprecated — kept for backward compat
    "volume.act1":                 (0.50, 1.00),
    "volume.act2":                 (0.80, 1.50),
    "volume.act3":                 (0.30, 1.40),
    "volume.ending":               (0.50, 1.60),
...
PARAM_DEFAULTS: dict[str, float] = {
    ...
    "ducking.speech_volume": 0.18,
    "ducking.silence_volume": 0.28,
    "ducking.attack_seconds": 0.1,
    "ducking.release_seconds": 0.4,
    "ducking.ramp_seconds": 0.5,  # deprecated
    "volume.act1": 0.85,
    "volume.act2": 1.00,
    "volume.act3": 1.25,
    "volume.ending": 0.90,
    ...
    "stem_ducking.bass.speech": 0.10,
    "stem_ducking.bass.silence": 0.35,
    "stem_ducking.drums.speech": 0.08,
...
PARAM_MIN_STEP: dict[str, float] = {
    ...
    "ducking.speech_volume": 0.01,
    "ducking.silence_volume": 0.02,
    "ducking.attack_seconds": 0.02,
    "ducking.release_seconds": 0.05,
    "ducking.ramp_seconds": 0.05,
